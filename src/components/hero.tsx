...
export function Hero() {
  ...
  const linesEn = [
    "> Hello! I'm Yesid Banguera_",
    "> Full Stack Developer_",
    "> Creating unique web experiences_",
    "> Transforming ideas into code_",
  ]

  const lines = language === "es" ? linesEs : linesEn
            ...
            <div className="font-mono space-y-4">
              ...
              <div className="space-y-2 text-lg md:text-xl text-muted-foreground">
                <p className="flex items-center gap-2">
                  ...
                  <span>{t("Especializado en Vtex & Next.js", "Specialized in Vtex & Next.js")}</span>
                </p>
                <p className="flex items-center gap-2">
                  <span className="text-green-500">✓</span>
                  <span>{t("Diseño UI/UX minimalista", "Minimalist UI/UX design")}</span>
                </p>
                <p className="flex items-center gap-2">
                  <span className="text-green-500">✓</span>
                  <span>{t("Soluciones full-stack escalables", "Scalable full-stack solutions")}</span>
                </p>
              </div>
            </div>
          </div>
