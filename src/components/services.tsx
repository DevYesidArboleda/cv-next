...
export function Services() {
  ...
  return (
    <section id="services" className="min-h-screen flex items-center px-6 py-20">
      <div className="max-w-4xl mx-auto w-full">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {services.map((service, index) => (
            <div
              key={index}
              className="group p-6 rounded-lg border border-border hover:border-primary bg-card hover:bg-muted/50 transition-all"
            >
